  ...
  public FileUploadResponse upload(
    ...
    try {
      ...
      try (InputStream first = Files.newInputStream(retryableCopy)) {
        return uploadService.upload(originalFilename, declaredContentType, first, knowledgeBaseId);
        ...
        try {
          return uploadService.findDuplicateAfterConflict(detectedMime, sha256, knowledgeBaseId);
